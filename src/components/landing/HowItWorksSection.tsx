...
=======
import { Monitor, Palette, Download, Puzzle } from "lucide-react";
import type { LucideIcon } from "lucide-react";
      ...
      >
        <svg width="16" height="20" viewBox="0 0 16 20" fill="none">
          <path
            ...
            className="fill-foreground/50 stroke-foreground/30"
            strokeWidth="0.5"
          />
        </svg>
      </div>
...
function ExportScene() {
  return (
    <div className="relative flex flex-col items-center justify-center h-full w-full gap-4">
      ...
      <div className="relative">
        <div className="w-14 h-18 rounded-lg bg-foreground/5 border border-border flex items-center justify-center">
          <div className="text-[10px] font-mono font-bold text-muted-foreground tracking-wide">
            .webm
          </div>
        </div>
        {/* Corner fold */}
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, transparent 50%, color-mix(in srgb, var(--primary) 20%, transparent) 50%)",
            borderRadius: "0 6px 0 4px",
          }}
        />
        {/* Checkmark */}
        ...
        <div className="h-1 w-full rounded-full bg-foreground/10 overflow-hidden">
          <div
            ...
            style={{
              width: "100%",
              background:
                "linear-gradient(90deg, color-mix(in srgb, var(--primary) 60%, transparent), color-mix(in srgb, var(--primary) 30%, transparent))",
              animation: "shimmer 2s ease-in-out infinite",
            }}
          />
        </div>
...
=======
              style={{
                background: `linear-gradient(90deg, transparent, color-mix(in srgb, ${step.accent} 30%, transparent), transparent)`,
              }}
>>>>>>> Stashed changes
            />
          </div>
